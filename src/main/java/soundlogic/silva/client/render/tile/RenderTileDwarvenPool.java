...
public class RenderTileDwarvenPool extends TileEntitySpecialRenderer {

	private static final ResourceLocation texture = new ResourceLocation(LibResources.MODEL_DWARVEN_POOL);
	...
	public void renderTileEntityAt(TileEntity tileentity, double d0, double d1, double d2, float f) {
		TileDwarvenPool pool = (TileDwarvenPool) tileentity;
