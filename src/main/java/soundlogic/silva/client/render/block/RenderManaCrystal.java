...
public class RenderManaCrystal implements ISimpleBlockRenderingHandler {

	@Override
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) {
		GL11.glPushMatrix();
		GL11.glTranslatef(-0.5F, -0.7F, -0.5F);
		TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileManaCrystal(), 0.0D, 0.0D, 0.0D, 0.0F);
		GL11.glPopMatrix();
	}
