...
public class RenderPixieDust implements ISimpleBlockRenderingHandler {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z,
        ...
        Color color = new Color(ModBlocks.pixieDust.colorMultiplier(world, x, y, z));
        ...
        tessellator.setBrightness(ModBlocks.pixieDust.getMixedBrightnessForBlock(world, x, y, z));
	...
	private boolean shouldConnect(IBlockAccess world, int x, int y, int z, int side) {
		return world.getBlock(x, y, z) == ModBlocks.pixieDust;
	}
