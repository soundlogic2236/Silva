...
public class ModelNidhogg extends ModelBase {

    /** The head Model renderer of the Nidhogg */
    private ModelRenderer head;
    /** The spine Model renderer of the Nidhogg */
    private ModelRenderer spine;
    /** The jaw Model renderer of the Nidhogg */
    private ModelRenderer jaw;
    /** The body Model renderer of the Nidhogg */
    private ModelRenderer body;
    /** The rear leg Model renderer of the Nidhogg */
    private ModelRenderer rearLeg;
    /** The front leg Model renderer of the Nidhogg */
    private ModelRenderer frontLeg;
    /** The rear leg tip Model renderer of the Nidhogg */
    private ModelRenderer rearLegTip;
    /** The front leg tip Model renderer of the Nidhogg */
    private ModelRenderer frontLegTip;
    /** The rear foot Model renderer of the Nidhogg */
    private ModelRenderer rearFoot;
    /** The front foot Model renderer of the Nidhogg */
    private ModelRenderer frontFoot;
    /** The wing Model renderer of the Nidhogg */
    private ModelRenderer wing;
    /** The wing tip Model renderer of the Nidhogg */
    private ModelRenderer wingTip;
    private float partialTicks;
    private static final String __OBFID = "CL_00000870";

    public ModelNidhogg(float p_i1169_1_)
    {
    ...
    {
        GL11.glPushMatrix();
        EntityNidhoggEcho entityNidhogg = (EntityNidhoggEcho)p_78088_1_;
        float f6 = entityNidhogg.prevAnimTime + (entityNidhogg.animTime - entityNidhogg.prevAnimTime) * this.partialTicks;
        ...
        float f10 = 0.0F;
        float f11 = 1.5F;
        double[] adouble = entityNidhogg.getMovementOffsets(6, this.partialTicks);
        float f12 = this.updateRotations(entityNidhogg.getMovementOffsets(5, this.partialTicks)[0] - entityNidhogg.getMovementOffsets(10, this.partialTicks)[0]);
        float f13 = this.updateRotations(entityNidhogg.getMovementOffsets(5, this.partialTicks)[0] + (double)(f12 / 2.0F));
        f8 += 2.0F;
        ...
        for (int i = 0; i < 5; ++i)
        {
            double[] adouble1 = entityNidhogg.getMovementOffsets(5 - i, this.partialTicks);
        ...
        double[] adouble2 = entityNidhogg.getMovementOffsets(0, this.partialTicks);
        ...
        f9 = 60.0F;
        f10 = 0.0F;
        adouble = entityNidhogg.getMovementOffsets(11, this.partialTicks);

        for (int k = 0; k < 12; ++k)
        {
            adouble2 = entityNidhogg.getMovementOffsets(12 + k, this.partialTicks);
