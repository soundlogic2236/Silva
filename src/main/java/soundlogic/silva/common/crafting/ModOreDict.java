...
public class ModOreDict {
	...
	public static void preInit() {
		...
		OreDictionary.registerOre(LibOreDict.BIFROST_SHARD, new ItemStack(ModItems.simpleResource,1,0));
		OreDictionary.registerOre(LibOreDict.PARADOX_TWIG, new ItemStack(ModItems.simpleResource,1,3));
