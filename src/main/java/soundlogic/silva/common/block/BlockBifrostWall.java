...
public class BlockBifrostWall extends BlockWall implements IBifrostBlock,ILexiconable {

	public BlockBifrostWall() {
		super(ModBlocks.bifrostBlock);
		setBlockName(LibBlockNames.BIFROST_BLOCK_WALL);
