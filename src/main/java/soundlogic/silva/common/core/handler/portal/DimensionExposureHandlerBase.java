...
public class DimensionExposureHandlerBase implements IDimensionalExposureHandler{
	...
	public void init(Dimension dim) {
		...
		case FOLKVANGR:
			...
			addAttributeModifier(SharedMonsterAttributes.movementSpeed,UUID.randomUUID(),0.99,2,60*20*2);
			addAttributeModifier(SharedMonsterAttributes.knockbackResistance,UUID.randomUUID(),1.05,2,60*20*2);
			break;
		case VALHALLA:
			addAttributeModifier(SharedMonsterAttributes.attackDamage,UUID.randomUUID(),1.10,2,60*20*2);
			addAttributeModifier(SharedMonsterAttributes.movementSpeed,UUID.randomUUID(),1.10,2,60*20*2);
			addAttributeModifier(SharedMonsterAttributes.knockbackResistance,UUID.randomUUID(),0.75,2,60*20*2);
			break;
		case HELHEIM:
			addAttributeModifier(SharedMonsterAttributes.attackDamage,UUID.randomUUID(),0.95,2,60*20);
			addAttributeModifier(SharedMonsterAttributes.movementSpeed,UUID.randomUUID(),0.95,2,60*20);
			break;
		case ASGARD:
			addAttributeModifier(SharedMonsterAttributes.maxHealth,UUID.randomUUID(),2,1,60*20*3);
			addAttributeModifier(SharedMonsterAttributes.attackDamage,UUID.randomUUID(),1.02,2,60*20*3);
			break;
		case ALFHEIM:
			addAttributeModifier(SharedMonsterAttributes.movementSpeed,UUID.randomUUID(),1.02,2,60*20);
			break;
		case MINEGARD:
			break;
		case JOTUNHEIMR:
			addAttributeModifier(SharedMonsterAttributes.attackDamage,UUID.randomUUID(),1.05,2,60*20*1);
			addAttributeModifier(SharedMonsterAttributes.movementSpeed,UUID.randomUUID(),.95,2,60*20*1);
			addAttributeModifier(SharedMonsterAttributes.attackDamage,UUID.randomUUID(),1.15,2,60*20*3);
			addAttributeModifier(SharedMonsterAttributes.movementSpeed,UUID.randomUUID(),.85,2,60*20*3);
			addAttributeModifier(SharedMonsterAttributes.attackDamage,UUID.randomUUID(),1.25,2,60*20*5);
			addAttributeModifier(SharedMonsterAttributes.movementSpeed,UUID.randomUUID(),.75,2,60*20*5);
			break;
		case SVARTALFHEIM:
			break;
		case MUSPELHEIM:
